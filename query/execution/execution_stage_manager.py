"""
===============================================================================
Module: query.execution.execution_stage_manager
...
class ExecutionStageManager:
    ...
    def get(self, identifier: str) -> ExecutionStage | None:
        """Retrieve a stage by identifier. Returns None if not found."""
    ...
    def build(self, stages: tuple[str, ...]) -> ExecutionPipeline:
        return self._builder.build(stages)
